<template>
	<view class="content">
		<view class="dateTag">
			<uni-tag size="small" :text="dataMsg.date1" @click="changeDate(1)" :type="dateType==1?'warning':'default'" :circle="true"></uni-tag>
			<uni-tag size="small" :text="dataMsg.date2" @click="changeDate(2)" :type="dateType==2?'warning':'default'" :circle="true"></uni-tag>
			<uni-tag size="small" :text="dataMsg.date3" @click="changeDate(3)" :type="dateType==3?'warning':'default'" :circle="true"></uni-tag>
			<uni-tag size="small" :text="dataMsg.date4" @click="changeDate(4)" :type="dateType==4?'warning':'default'" :circle="true"></uni-tag>
			<uni-tag size="small" :text="dataMsg.date5" @click="changeDate(5)" :type="dateType==5?'warning':'default'" :circle="true"></uni-tag>
			<uni-tag size="small" :text="dataMsg.date6" @click="changeDate(6)" :type="dateType==6?'warning':'default'" :circle="true"></uni-tag>
		</view>

		<view class="tj-sction">
			<view class="tj-item">
				<text class="num">{{statistic.orderCount}}</text>
				<text>{{dataMsg.dataOrderCount}}</text>
			</view>
			<view class="tj-item">
				<text class="num">￥{{statistic.orderAmount}}</text>
				<text>{{dataMsg.dataOrderAmount}}</text>
			</view>
		</view>
		<view class="title">
			<view class="left">
			...
			<view class="right">
				<text :class="{'active':topType=='1'}" @click="topType='1'">{{i18n.order.number}}</text>
				<text class="seperator">|</text>
				<text :class="{'active':topType=='2'}" @click="topType='2'">{{dataMsg.dataAmount}}</text>
			</view>
		</view>
	...
	export default {
		...
		onLoad(options) {
			uni.setNavigationBarTitle({
				title: this.i18n.data.dataTitle
			})
			this.changeDate(1);
		},
		onReady() {
		...
		computed: {
			...
			dataMsg() {
				return this.$i18nMsg().index.data
			},
			setSrc() {
