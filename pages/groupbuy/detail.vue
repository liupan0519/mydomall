			...
			inquiryGroupBuy(id) {
				...
				this.$api.request.groupBuyDetail(postData, res => {
					if (res.body.status.statusCode === '0') {
						...
						this.shareHref = this.$api.request.h5BaseUrl + '/#/pages/product/groupbuy?id=' + this.groupBuy.groupBuyProductDTO.groupBuyProductUuid+'&groupId='+this.groupBuy.groupBuyUuid;
					} else {
