...
const translateGroupBuyStatus = (groupBuyStatus) => {
	let groupBuyStatusDesc = groupBuyStatusObj.groupBuyStatus;
...
const translateWithdrawStatus = (withdrawStatus) => {
	let withdrawStatusDesc = withdrawStatusObj.withdrawStatus;
