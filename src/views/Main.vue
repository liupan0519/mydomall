			...
			<shrinkable-menu :shrink="shrink" @on-change="handleSubmenuChange" :theme="menuTheme" :before-push="beforePush"
			 :open-names="openedSubmenuArr" :menu-list="menuList">
				<div slot="top" class="logo-con">
					<span v-show="!shrink">mydomall</span>
						...
						<Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
							<Dropdown transfer trigger="click" @on-click="handleClickUserDropdown">
								...
								<DropdownMenu slot="list">
									<DropdownItem name="ownSpace">{{$t('main.ownSpace')}}</DropdownItem>
									<DropdownItem name="loginout" divided>{{$t('main.loginout')}}</DropdownItem>
								</DropdownMenu>
							</Dropdown>
	...
	export default {
		...
		methods: {
			init() {
				...
				this.userName = Cookies.get('merchantName');
				let messageCount = 3;
