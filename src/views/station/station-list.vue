  ...
  <div>
    ...
    >
      ...
      >
        ...
        <FormItem label="权重">
          <InputNumber :precision="2" v-model="editvalue.weight" style="width:80%"></InputNumber>
        </FormItem>
      </Form>
      <div slot="footer">
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              ...
              [h("span", {}, params.row.availableBalance||0)]
            );
          }
        },
        {
      ...
      this.$refs["editMerchantForm"].validate(valid => {
        if (valid) {
          ...
          var options = {
            ...
            province: this.editvalue.province,
            city: this.editvalue.city,
            district: this.editvalue.district,
      ...
      this.$refs["addMerchantForm"].validate(valid => {
        if (valid) {
          ...
          var options = {
            ...
            province: this.addvalue.province,
            city: this.addvalue.city,
            district: this.addvalue.district,
    ...
    onAddressLi(e) {
      ...
      if (this.openMapFrom == "add") {
        ...
        this.map.getCity(function(res){
          that.addvalue.province = res.province;
          //直辖市没有city数据, 使用province
          if(res.city){
            that.addvalue.city = res.city;
          }else{
            that.addvalue.city = res.province;
          }
          that.addvalue.district = res.district;
        });
        ...
        this.map.getCity(function(res){
          that.editvalue.province = res.province;
          //直辖市没有city数据, 使用province
          if(res.city){
            that.editvalue.city = res.city;
          }else{
            that.editvalue.city = res.province;
          }
          that.editvalue.district = res.district;
        });
      }
    },
    onSearchLi(e) {
