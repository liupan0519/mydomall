...
export default {
    ...
    methods: {
        ...
        searchMerchantWithdraw(){
            this.inquiryMerchantWithdraw(0, this.pageSize);
            this.resetpage();
        },
        //将分页页码重置成1
        resetpage() {
        ...
        //查询
        inquiryMerchantWithdraw(startIndex,pageSize){
            this.loading = true;
            let searchOptions = {
        ...
        changepage(index){
            ...
            this.inquiryMerchantWithdraw(_start,this.pageSize);
        },
        ...
        viewStatement(row){
            this.$router.push({
                ...
                query: {
                merchantUuid: row.merchantDTO.merchantUuid
                }
            });
        },
        confirmpayment(row){
