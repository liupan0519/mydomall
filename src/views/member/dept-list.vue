...
export default {
    ...
    methods: {
        ...
        del (row) {
            this.$Notice.success({
                title:  this.$('comment.success'),
                desc:  this.$('comment.deleteSuccess')/* '部门已删除' */,
                duration: 2
            });
            this.getData();
        },
        editok () {
            this.$Notice.success({
                title: this.$('comment.success'),
                desc: this.$('comment.saveSuccess')/* '部门信息已保存' */,
                duration: 2
            });
            this.getData();
        },
